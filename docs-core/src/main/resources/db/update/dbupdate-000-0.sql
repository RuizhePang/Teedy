...
create memory table T_REGISTER_REQUEST ( RRQ_ID_C varchar(36) not null, RRQ_NAME_C varchar(100) not null, RRQ_EMAIL_C varchar(100) not null, RRQ_PASSWORD_C varchar(100) not null, RRQ_STATUS_C varchar(20) not null, RRQ_CREATEDATE_D datetime not null, RRQ_REVIEWUSERID_C varchar(36), RRQ_REASON_C varchar(1000), RRQ_DELETDATE_D datetime, primary key (RRR_ID_C) );
